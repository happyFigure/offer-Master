...
- 用户想列出数据库里的公司，问数据库里有没有某家公司，或者想看某家公司的完整档案。
...
2. 公司列表和公司查询要同时核对正式企业表、正式岗位表、岗位线索表和招聘信号表。
...
- 允许自动执行公司列表、公司查询、公司详情、岗位查询和来源查询这些只读工具。
...
- 公司列表返回去重公司、是否已有正式档案、岗位/线索/招聘信号数量和当前展示条数。
